...
def decode_bits_advanced(bits: str) -> str:
    ...
    Notes:
        ...
        4. Observations:
            1st sample: 110110100111000001100000011111101001111100111111000000000001110111111110111110111110000001011000111111000001111100111011000001
                on-off pairs: 2, 1,  2, 1,  1, 2,  3, 5,  2, 6,  6, 1,  1, 2,  5, 2,  6, 11,  3, 1,  8, 1,  5, 1,  5, 6,  1, 1,  2, 3,  6, 5,  5, 2,  3, 1,  2, 5,  1
                statistic:    dot(1-3), dash(5-8), pause_dot/dash(1-3), pause_chars(5-6), pause_words(11)
                morse:        . . . .   .   - . - -     . - - -   . . -   - . .   .
                message:      H         E   Y           J         U       D       E
            2nd sample: 
                on-off pairs: 7, 6,  2, 1,  1, 3,  3, 1,  3, 8,  3, 18,  7, 1,  6, 4,  2, 1,  5, 5,  4, 2,  4, 3,  6, 7,  1, 1,  3, 6,  7, 2,  1, 3,  5, 2,  2, 5,  6, 2,  1, 1,  5, 14,  7, 4,  4, 1,  1, 1,  2, 5,  2, 3,  5, 2,  1, 5,  7, 3,  6, 2,  7, 5,  1, 3,  6, 3,  8, 7,  8, 1,  3, 14,  1, 1,  2, 4,  8, 1,  4, 5,  5, 1,  5, 2,  7, 8,  5, 2,  1, 1,  2, 1,  5, 12,  3, 1,  5, 1,  5, 1,  5, 7,  1, 3,  1, 2,  5, 5,  5, 1,  8, 6,  3, 2,  6, 3,  5, 1,  1, 6,  2, 4,  1, 2,  1, 18,  8, 2,  5, 1,  6, 6,  1, 3,  1, 2,  1, 4,  5, 6,  1, 8,  1, 1,  5, 1,  1, 13,  6, 6,  4, 1,  1, 4,  1, 2,  2, 10,  3, 15,  2, 1,  5, 1,  4, 3,  1, 5,  1, 4,  9, 9,  6, 2,  6, 3,  3, 1,  2, 5,  6, 4,  2, 1,  5, 3,  6, 17,  6, 4,  1, 2,  2, 5,  6, 1,  7, 1,  9, 7,  6, 3,  5, 4,  1
                statistic:    dot(1-4), dash(5-9), pause_dot/dash(1-4), pause_chars(5-10), pause_words(12-18)
                morse:        -   . . . .   .     - - . -   . . -   . .   - . - .   - . -     - . . .   . - .   - - -   . - -   - .     . . - .   - - -   - . . -     . - - -   . . -   - -   . - - .   . . .     - - -   . . . -   .   . - .     -   . . . .   .     . - . .   . -   - - . .   - . - -     - . .   - - -   - - .
                message:      T   H         E     Q         U       I     C         K         B         R       O       W       N       F         O       X           J         U       M     P         S         O       V         E   R         T   H         E     L         A     Z         Y           D       O       G

    Examples:
        import A2_signal_processing as A2
        encrypted = [A2.decode_morse(A2.decode_bits_advanced(s)) for s in ('1001','10001','100001','10000001','100000001','1000000001','10000000001','10111','111','1111111','101','110011','111000111','111110000011111','1110111','11111100111111','110110100111000001100000011111101001111100111111000000000001110111111110111110111110000001011000111111000001111100111011000001','1100110011001100000011000000111111001100111111001111110000000000000011001111110011111100111111000000110011001111110000001111110011001100000011','')]
        encrypted == ['EE','EE','EE','E E','E E','E E','E E','A','E','E','I','I','I','I','M','M','HEY JUDE','HEY JUDE','THE QUICK BROWN FOX JUMPS OVER THE LAZY DOG']
    """
